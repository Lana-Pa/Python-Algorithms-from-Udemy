...
class LinkedList(object):
    ...
    def delete_first(self):
        ...
        if self.head:
            deleted_element = self.head         # define 1st element as element to delete
            temp = deleted_element.next         # set the temp element to the next (2nd element)
            self.head = temp                    # set the new head of the list
